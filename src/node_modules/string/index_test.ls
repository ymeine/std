...
$logger.fail -> string.capitalize 5
$logger.fail -> string.capitalize on
$logger.fail -> string.capitalize {}
$logger.fail -> string.capitalize []
...
sample = 'Hello mister   DJ!'
$logger.log sample

$logger.fail -> string.split!
$logger.fail -> string.split sample
$logger.log string.split sample, ({item:current, input, index}) ->
	before = input[index - 1]
	space = ' '
	{
		split: (current is space and before isnt space) or (before is space and current isnt space)
		+keep
	}
$logger.log string.split sample, ({item}) -> {
	split: item is ' '
	-keep
}
...
$logger.separator 'Split at'
$logger.on!

sample = 'Hello mister DJ!'
$logger.log sample

$logger.fail -> string.splitAt!
$logger.fail -> string.splitAt sample
$logger.log string.splitAt sample, [5 6 12 13 15]
...
sample = 'Hello yourself, how are you?'
$logger.log sample
...
$logger.log string.replace sample, 'myself' 6 14
...
$logger.log string.insert sample, 'Hey ' void
$logger.log string.insert sample, 'Hey ' 'lol'
