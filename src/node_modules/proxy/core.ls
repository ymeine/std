...
class Proxifier
	...
	# WARNING Return needed: this generates an explicit return statement in JS constructor (only function for which the return statement is not automatic), thus enabling us to override the constructed object
	(@instance = {}) ~> return Proxy.create @
